...
app.post("/api/chat", async (req, res) => {
  ...
  const response = await client.messages.create({
    ...
    max_tokens: 1024,
    system: "Du bist ein hilfreicher Website-Assistent. Beantworte Fragen NUR basierend auf dem gegebenen Website-Kontext. Wenn die Antwort nicht im Kontext steht, sage das ehrlich.",
    messages: [
      {
        role: "user",
